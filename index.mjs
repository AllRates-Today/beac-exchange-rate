// Bank of Central African States (BEAC) exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/beac';
...
/** Latest rate for one pair, e.g. getRate('USD', 'XAF', { apiKey }). */
